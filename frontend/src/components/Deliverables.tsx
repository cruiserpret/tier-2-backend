const DELIVERABLES = [
  { icon: "◎", title: "Predicted Trial Rate", desc: "Comparable-anchored estimate of 12-month trial rate, with low/high range and confidence level.", example: "Predicted trial rate with low/high range and confidence — based on real comparable brands" },
  ...
  { icon: "▲", title: "Anchored Comparables", desc: "The actual brands the forecast was anchored on, their trial rates, and why they matched.", example: "Each anchor brand shown with its measured trial rate and source grade" },
